...
def upgrade() -> None:
    ...
    test_data_users = [{'username': 'user', 'password': pswds['user1234'], 'register_time': time},
                       {'username': 'user1', 'password': pswds['user5467'], 'register_time': time + timedelta(hours=2)},
                       {'username': 'user2', 'password': pswds['user5357'], 'register_time': time + timedelta(hours=3)}]
